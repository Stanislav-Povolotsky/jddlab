...
Verify Java bytecode with ASM. This is the explicit `d2j-` command name.
...
```text
docker run --rm -v "<host-mount-root>:/work" stanislavpovolotsky/jddlab:latest d2j-asm-verify <args>
```

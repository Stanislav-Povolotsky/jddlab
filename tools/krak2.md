...
Short alias for Krakatau v2.

See `krakatau2.md`. Run `krak2 help` for the complete version-specific subcommand list.
...
```text
docker run --rm -v "<host-mount-root>:/work" stanislavpovolotsky/jddlab:latest krak2 <args>
```
